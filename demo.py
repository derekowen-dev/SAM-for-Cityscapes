...
from config import PROJECT_ROOT, DATA_ROOT, SAM_CHECKPOINT, HEAD_WEIGHTS, OUT_MODELS_DIR
...
def main():
    idx_str = input("Enter validation index (0-499): ").strip()
    try:
        idx = int(idx_str)
    except ValueError:
        idx = 0
    ...
    out_dir = os.path.join(PROJECT_ROOT, "demos")
